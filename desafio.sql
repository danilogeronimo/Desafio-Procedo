...
--
-- Host: 127.0.0.1
-- Generation Time: 16-Abr-2019 às 01:53
...
INSERT INTO `cliente` (`cod`, `nome`, `email`, `cnpj`, `telefone`, `origem`, `estado_cod`, `cidade_cod`, `situacao`, `observacao`) VALUES
(58, 'cliente', 'cliente@cliente.com.br', '11.111.111/-11', '(14) 1234-53213', 'Site,Boca a Boca', 26, 4765, 1, 'teste');
...
INSERT INTO `situacao` (`cod`, `status`) VALUES
(1, 'ATIVO'),
(2, 'INATIVO');
...
CREATE TABLE `usuario` (
  ...
  `estado_cod` int(11) NOT NULL,
  `cidade_cod` varchar(255) NOT NULL,
  `situacao` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `usuario` (`cod`, `nome`, `email`, `senha`, `sexo`, `telefone`, `estado_cod`, `cidade_cod`, `situacao`) VALUES
(6, 'user', 'user@gmail.com', 'User12#', 'Masculino', '(14) 1231-23123', 26, '4773', 1),
(7, 'admin', 'admin@gmail.com', 'Adm!n23', 'Feminino', '(14) 1234-56123', 26, '4745', 1),
(8, 'danilo', 'danilo.geronimo@hotmail.com', 'S3nh@123', 'Masculino', '(14) 9818-30533', 26, '4773', 1),
(9, 'Estagiario', 'estagiario@sofre.com', 'Est@g10', 'Masculino', '(14) 9222-22222', 26, '4764', 1);
